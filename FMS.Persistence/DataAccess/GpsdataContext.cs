...
public partial class GpsdataContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseMySql("server=10.0.10.150;port=3306;database=gpsdata;user=root;password=Niwewenamimi1000", Microsoft.EntityFrameworkCore.ServerVersion.Parse("5.5.61-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Vehicle>(entity =>
        {
            ...
            entity.HasIndex(e => e.AssetId, "vehicle_assest_idx");
            ...
            entity.HasOne(d => d.Asset).WithMany(p => p.Vehicles)
                .HasForeignKey(d => d.AssetId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("vehicle_assest");
        ...
        {
            entity.HasKey(e => new { e.VehicleId, e.Date, e.IsNightShift })
                .HasName("PRIMARY")
            ...
            entity.Property(e => e.VehicleId)
                .HasColumnType("int(11)")
                .HasColumnName("VehicleID");
            entity.Property(e => e.IsNightShift).HasColumnType("tinyint(4)");
            entity.Property(e => e.AvgSpeed).HasPrecision(10);
            ...
            entity.Property(e => e.FuelEfficiency).HasPrecision(10);
            entity.Property(e => e.FuelLost).HasPrecision(10);
            entity.Property(e => e.MaxSpeed).HasPrecision(10);
            entity.Property(e => e.SiteId)
                .HasColumnType("int(11)")
                .HasColumnName("SiteID");
        ...
        modelBuilder.Entity<Vehicletype>(entity =>
        {
            ...
            entity.Property(e => e.Id)
                ...
                .HasColumnType("int(11)")
                .HasColumnName("ID");
            entity.Property(e => e.IsKmPerLiter)
