            ...
            if($i%2 == 0) {
                ...
                if($this->tdbegin) {
                    ...
                    **/
                    ...
                    $x=$this->GetX();
                    $y=$this->GetY();
                    // $this->Rect($x,$y,$this->tdwidth,$this->tdheight); // as a space/table header
                    ...
                    if(trim($e) != '') {
                        ...
                        $this->SetXY($x+$this->tdwidth,$y); // align second column
                    }
        ...
        switch($tag) {
            ...
            case 'IMG':
                if(isset($attr['SRC']) && (isset($attr['WIDTH']) || isset($attr['HEIGHT']))) {
                    ...
                    // Find image extension (because we might also use base64)
                    $ext = null;
                    $filename_lower = strtolower($attr['SRC']);
                    if(strpos($filename_lower, 'png'))         $ext = 'PNG';
                    elseif(strpos($filename_lower, 'jpg'))     $ext = 'JPG';
                    elseif(strpos($filename_lower, 'jpeg'))    $ext = 'JPG';
                    elseif(strpos($filename_lower, 'gif'))     $ext = 'GIF';
                    // --
