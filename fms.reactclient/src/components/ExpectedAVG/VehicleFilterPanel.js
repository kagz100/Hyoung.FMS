...
const VehicleFilterPanel = ({ setSelectedVehicles }) => {
    ...
    return (
       ...
       <Editing
                ...
                <Column dataField="workingSiteId" caption="Working Site"  allowEditing={true}>
                    <Lookup dataSource={workingSiteDataSource} valueExpr="id" displayExpr="name"   allowEditing={false}/>
                </Column>
