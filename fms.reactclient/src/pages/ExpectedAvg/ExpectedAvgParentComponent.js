import VehicleFilterPanel from '../../components/ExpectedAVG/VehicleFilterPanel';
import CreateExpectedAVG from '../../components/ExpectedAVG/CreateExpectedAVG';
    ...
    return (
        ...
        <div>
            ...
            <div className="row align-items-end">
                    <div className=' '>
                    <button className="btn btn-warning " onClick={clearVehicles}>Clear</button></div>
